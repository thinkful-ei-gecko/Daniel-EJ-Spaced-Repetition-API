    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: 'heute', translation: 'today' },
            { original: 'morgen', translation: 'tomorrow' },
            { original: 'gestern', translation: 'yesterday' },
            { original: 'die Woche', translation: 'Week' },
            { original: 'das Jahr', translation: 'Year' },
            { original: 'die Stunde', translation: 'hour' },
            { original: 'Guten Morgen', translation: 'Good morning' },
            { original: 'Taschenrechner', translation: 'Calculator' },
            { original: 'das Frühstück', translation: 'breakfast' },
            { original: 'das Abendessen', translation: 'dinner' },
          ],
        };
        return supertest(app)
          .post('/api/user')
